...
//                 <div>
//                     <h1 className='text-4xl font-bold heading text-center py-10'>Admin Login</h1>
//                 </div>
//                 {/* input field */}
...
//                         </div>
//                         <div>
//                             <p>For register, Please <span className='underline text-blue-500'><Link to={'/register'}>Register</Link></span></p>
//                         </div>
//                     </form>
//                 </div>
//             </div>
