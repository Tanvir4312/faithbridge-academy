...
const ApplicationTimeControl = () => {
     const axiosSecure = useAxiosSecure()

    const handleApplicationTime = async e => {
        e.preventDefault()
        ...
        await axiosSecure.patch('/application-time', application_time);
        toast.success('Application time update successfully')
        form.reset()
    }
  return (
    <div className='max-w-5xl mx-auto mb-8 px-3'>
            <h1 className='text-3xl font-bold my-5'> Application Time Control</h1>

            <form onSubmit={handleApplicationTime}>
                {/* Time */}
...
export default ApplicationTimeControl
