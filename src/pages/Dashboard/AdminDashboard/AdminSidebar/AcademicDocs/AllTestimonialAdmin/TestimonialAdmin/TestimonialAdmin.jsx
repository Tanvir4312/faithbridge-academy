...
const TestimonialAdmin = ({testimonial, refetch}) => {
     const axiosSecure = useAxiosSecure()
    const { registration_no, student_name, type, transactionId, identity_doc_img, status, email, _id } = testimonial || {}
       // Accept
        const handleAccept = id => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        await axiosSecure.patch(`/academic-docs-update/${id}?text=testimonial`)
        ...
        const handleDelete = id => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        await axiosSecure.delete(`/academic-docs-delete/${id}?text=testimonial`)
