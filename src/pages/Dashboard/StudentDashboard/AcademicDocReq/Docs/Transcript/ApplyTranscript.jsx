...
const ApplyTranscript = () => {
    ...
    const handleDocs = async (e) => {
        ...
        navigate('/dashboard/all-transcript-application')

    }
    return (
        <div>
            <h2 className='text-2xl text-center my-4'>Application for Transcript</h2>
            ...
            {/* <div className='bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded'>
                <div className=" relative flex items-center" role="alert">
                    ...
                    <span className="font-bold">বিশেষ সতর্কতা!</span>
                ...
                <ul className='list-disc pl-6 pt-3'>
                    <li>
                        ফলাফল প্রকাশের ৭ কার্যদিবসের মধ্যে মার্কশীট প্রশাসনিক অফিসে প্রেরণ করা হয়। তাই, মার্কশীটের আবেদন করার পূর্বে অবশ্যই প্রশাসনিক অফিসে খোঁজ নিন।
                    </li>
                    <li>
                        সনদ হারিয়ে গেলে সংশ্লিষ্ট থানায় জিডি করতে হবে এবং সনদ সংগ্রহের সময় জিডির কপি অবশ্যই জমা দিতে হবে।
                    </li>
                    <li>
